    ...
    },
    {
      ...
      children: [
        // Dashboard
        {
         ...
         {
          name: 'Perfil',
          path: 'cadastros/perfil/abas',
          component: () => import('@/views/dashboard/cadastros/perfil/Abas')
        },
        {
          name: 'Usuario',
          path: 'cadastros/usuario/abas',
          component: () => import('@/views/dashboard/cadastros/usuario/Abas')
        },
        ...
        {
          name: 'Grid System',
          path: 'dashboard/components/grid-system',
          component: () => import('@/views/dashboard/component/Grid')
        },
        {
          name: 'Tabs',
          path: 'dashboard/components/tabs',
